...
<head>
  ...
  <title>{{ config('app.name', 'Consultant') }} </title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="{{asset('logo/ln.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">{{ config('app.name', 'Namaste') }}</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="/consultant" class="nav-link {{ Request::path()=='consultant' ? 'active' : '' }}">
              ...
              @if (Request::is('company/create') || Request::is('company')  )
              ...
              @endif
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{url('company/create')}}" class="nav-link {{ Request::is('company/create') ? 'active' : '' }}">
